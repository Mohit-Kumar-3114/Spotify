...
const Home=()=>{
    ...
    return(
        ...
        <button onClick={handleNavigate2}className="h-12 w-28 text-zinc-400 font-bold">Sign up</button>
        <button onClick={handleNavigate}className="bg-white rounded-full h-12 w-28 text-inherit font-bold"> Log in</button>
        </div>
        </div>
