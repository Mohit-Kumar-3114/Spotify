...
const Dashboard=()=>{
    ...
    return (
        <div className="bg-gradient-to-b from-neutral-800 via-neutral-900 to-neutral-950 h-screen w-full">
        ...
        <button onClick={handleNavigate}className="bg-white rounded-full h-12 w-28 text-inherit font-bold"> Add Song</button>
        </div>
        </div>
          <Song/>
        </div>
